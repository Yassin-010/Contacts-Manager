...
namespace Contact_Manager.ContactManager
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                new Contact("mohammad alfrwan", "111-222-3333", ContactType.Family),
                new Contact("Yassin", "111-222-4444", ContactType.Family),
                new Contact("Moath alhariri", "111-222-5555", ContactType.Family),
